...
\\
&=&
	1 \cdot P\!\left(\left.W^{(i)}_{c \vert g} = 1\,\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
	\;\;+\;\;
	0 \cdot P\!\left(\left.W^{(i)}_{c \vert g} = 0\,\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
\\
&=&
	P\!\left(\left.W^{(i)}_{c \vert g} = 1\,\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
\\
&=&
	P\!\left(\left.X^{(i)} = g\,,\,Y^{(i)} = c\,\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
\\
&=&
	P\!\left(\left.X^{(i)} = g\,,\,Y^{(i)} = c\,,\,M^{(i)}=0\,\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
\\
&&
	+ \;\; P\!\left(\left.X^{(i)} = g\,,\,Y^{(i)} = c\,,\,M^{(i)}=1\,\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
\\
&=&
	P\!\left(\left.X^{(i)} = g\,,\,Y^{(i)} = c\,\;\right\vert\,M^{(i)}=0,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
	\,\cdot\,
	P\!\left(\left.M^{(i)}=0\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
\\
&&
	+ \;\;
	P\!\left(\left.X^{(i)} = g\,,\,Y^{(i)} = c\,\;\right\vert\,M^{(i)}=1,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
	\,\cdot\,
	P\!\left(\left.M^{(i)}=1\;\right\vert\,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
\\
&=&
	P\!\left(\left.X^{(i)} = g\,,\,Y^{(i)} = c\,\;\right\vert\,M^{(i)}=0,X^{(i)}=g,\widetilde{Y}^{(i)}=y,J^{(i)}=0\,\right)
	\,\cdot\,
