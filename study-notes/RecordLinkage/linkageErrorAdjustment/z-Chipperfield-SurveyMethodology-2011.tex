...
L &=&
	P\!\left(\;
		\left[\;\overset{n}{\underset{i=1}{\bigcap}}\;
		\left\{
		X^{(i)}=x_{i},Y^{(i)}=c_{i},\widetilde{Y}^{(i)}=y_{i},M^{(i)}=m_{i}
		\right\}\;\right]
		\;\bigcap\;
		\left[\;\overset{n}{\underset{i=1}{\bigcap}}\;
		\left\{
...
&=&
	\overset{n}{\underset{i=1}{\prod}} \;
	P\!\left(\,X^{(i)}=x_{i},Y^{(i)}=c_{i},\widetilde{Y}^{(i)}=y_{i},M^{(i)}=m_{i}\,\right)
	\;\times\;
	\overset{n}{\underset{i=1}{\prod}} \;
	P\!\left(\,J^{(i)}=j_{i}\,\right)
\\
&=&
	\overset{n}{\underset{i=1}{\prod}} \;\;
	P\!\left(\,X^{(i)}=x_{i},Y^{(i)}=c_{i},\widetilde{Y}^{(i)}=y_{i},M^{(i)}=m_{i}\,\right)
...
&=&
	...
	\left\{\;
		...
		\overset{1}{\underset{m=0}{\prod}}\;\;
		\overset{1}{\underset{j=0}{\prod}}\;
		\left(P\!\left(\,X=g,Y=c,\widetilde{Y}=y,M=m\,\right) \cdot P\!\left(\,J=j\,\right)\right)
		^{W^{(i)}_{c \vert gymj}}
	\;\right\}
\\
&=&
...
&=&
	...
	\overset{1}{\underset{j=0}{\prod}}\;
	\left[\;
		P\!\left(\,X=g,Y=c,\widetilde{Y}=y,M=m\,\right) \cdot P\!\left(\,J=j\,\right)
	\;\right]
	^{\overset{n}{\underset{i=1}{\sum}}\,W^{(i)}_{c \vert gymj}}
\end{eqnarray*}
...
\log\,L &=&
	...
	\overset{1}{\underset{j=0}{\sum}}\;
	\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{c \vert gymj}\right)
	\cdot
	\log\left[\,
		P\!\left(\,X=g,Y=c,\widetilde{Y}=y,M=m\,\right) \cdot P\!\left(\,J=j\,\right)
	\,\right]
...
&&
	...
	\cdot
	\log\left[\,
		P\!\left(\,Y=c\;\left\vert\;X=g,\widetilde{Y}=y,M=m\right.\,\right)
		P\!\left(\,X=g,\widetilde{Y}=y,M=m\,\right)
		\cdot
		P\!\left(\,J=j\,\right)
	\,\right]
\\
&=&
	...
	\cdot
	\log\left[\,
		\pi_{c \vert gym} \cdot \mu_{gym} \cdot \nu_{j}
	\,\right]
%\\
%&=&
%	\overset{G}{\underset{g=1}{\sum}}\;\;
...
%	\cdot
%	\left(\,
%		\overset{{\color{white}.}}{\log}\,\pi_{c \vert gym} + \log\,\mu_{gym} + \log\,\nu_{j}
%	\,\right)
\\
&=&
	\overset{G}{\underset{g=1}{\sum}}\;\;
	...
	\overset{C}{\underset{y=1}{\sum}}\;\;
	\overset{1}{\underset{m=0}{\sum}}\;\;
	\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{c \vert gym{\color{blue}0}}\right)
	\cdot
	\log\left[\,
		\pi_{c \vert gym} \cdot \mu_{gym} \cdot \nu_{\color{blue}0}
	\,\right]
...
&&
	...
	\overset{C}{\underset{y=1}{\sum}}\;
	\left[\;
		\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{c \vert gy\color{red}0{\color{blue}1}}\right)
		\cdot
		\log\left[\,
			\pi_{c \vert gy{\color{red}0}} \cdot \mu_{gy{\color{red}0}} \cdot \nu_{\color{blue}1}
		\,\right]
		\;+\;
		\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{c \vert gy\color{red}1\color{blue}1}\right)
		\cdot
		\log\left[\,
			\pi_{c \vert gy\color{red}1} \cdot \mu_{gy\color{red}1} \cdot \nu_{\color{blue}1}
		\,\right]
	\;\right]
\end{eqnarray*}
...
\log\,L &=&
	...
	\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{c \vert gymj}\right)
	\cdot
	\log\,P\!\left(\,X=g,Y=c,\widetilde{Y}=y,M=m,J=j\,\right)
\\
&=&
	\overset{G}{\underset{g=1}{\sum}}\;\;
	\overset{C}{\underset{c=1}{\sum}}\;\;
...
&&
	...
	\cdot
	\log\left[\,
		P\!\left(\,Y=c\;\left\vert\;X=g,\widetilde{Y}=y,M=m,J=j\right.\,\right)
		P\!\left(\,X=g,\widetilde{Y}=y,M=m,J=j\,\right)
	\,\right]
\\
&=&
	\overset{G}{\underset{g=1}{\sum}}\;\;
	...
	\cdot
	\log\left[\,
		\pi_{c \vert gymj} \overset{{\color{white}\vert}}{\cdot} p_{gymj}
	\,\right]
\\
&=&
	\overset{G}{\underset{g=1}{\sum}}\;\;
	...
	\cdot
	\log\left[\,
		\pi_{c \vert gym\color{blue}0} \cdot p_{gym\color{blue}0}
	\,\right]
\\
&&
	+ \;\;
	...
	\left\{\;
		...
		\cdot
		\log\left[\,
			\pi_{c \vert gy{\color{red}0}\color{blue}1} \overset{{\color{white}\vert}}{\cdot} p_{gy{\color{red}0}\color{blue}1}
		\,\right]
		\;+\;
		\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{c \vert gy\color{red}1\color{blue}1}\right)
		\cdot
		\log\left[\,
			\pi_{c \vert gy\color{red}1\color{blue}1} \overset{{\color{white}\vert}}{\cdot} p_{gy\color{red}1\color{blue}1}
		\,\right]
	\;\right\}
\end{eqnarray*}
