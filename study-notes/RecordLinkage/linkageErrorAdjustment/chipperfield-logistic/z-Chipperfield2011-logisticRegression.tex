...
&&
	...
	\underset{x\in\{0,1\}^{p}}{\sum}\;
	\overset{1}{\underset{y=0}{\sum}}\;\;
	\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{1 \vert xy{\color{red}1}}\right)
	\cdot
	\log\!\left(\,
		\logisticBetaX %\overset{{\color{white}+}}{\pi}_{1 \vert x}
		\,\right)
\\
&&
	+ \;\;
	\underset{x\in\{0,1\}^{p}}{\sum}\;
	\overset{1}{\underset{y=0}{\sum}}\;\;
	\left(\overset{n}{\underset{i=1}{\sum}}\;W^{(i)}_{0 \vert xy{\color{red}1}}\right)
	\cdot
	\log\!\left(\,
		\oneMinusLogisticBetaX %\overset{{\color{white}+}}{\pi}_{0 \vert x}
		\,\right)
\\
&&
	+ \;\;
