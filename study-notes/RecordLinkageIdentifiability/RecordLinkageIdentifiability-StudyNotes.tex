...
\chead[]{{\Large\bf Identifiability in Fellegi-Sunter Probabilistic Record Linkage} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-FellegiSunter-ProbabilisticRecordLinkage.tex}
...
\bibliography{RecordLinkageIdentifiability-StudyNotes}
