...
\chead[]{{\Large\bf 2017 MA-04 Competition} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-sample-allocation}

\clearpage
\input{z-variance-estimation}

\clearpage
\input{z-nonresponse-adjustments}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\clearpage
\appendix
\input{z-with-replacement-sampling}
...
\bibliography{2017-MA04-competition-studyNotes}
