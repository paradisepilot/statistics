...
\chead[]{{\Large\bf Inference via Non-probability Samples} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\vskip -0.95cm
{\color{white}.}
\input{z-design-based-approach}

\clearpage
\input{z-propensity-score-approach}

\clearpage
\input{z-estimation-procedure}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\appendix
%\clearpage\input{z-technicalLemmas}
\clearpage\input{z-logisticRegression}
