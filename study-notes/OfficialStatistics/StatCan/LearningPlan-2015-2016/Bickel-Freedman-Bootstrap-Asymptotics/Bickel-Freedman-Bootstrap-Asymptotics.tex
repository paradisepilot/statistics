...
\chead[]{{\Large\bf Some Asymptotic Theory for the Bootstrap} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
This set of notes aims to provide complete proofs of a number of
asymptotic results regarding the Bootstrap \cite{Efron1979}
contained in Bickel and Freedman \cite{BickelFreedman1981}.

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\input{z-bootstrap-sample-mean.tex}
%\input{z-mean.tex}
...
%\clearpage
\appendix
\input{z-Wasserstein-spaces.tex}
\input{z-stochasticProcess-equivalent-randomVariable.tex}
\input{z-uniqueness-given-finiteDimensionalDistributions.tex}
\input{z-existence-given-finiteDimensionalDistributions.tex}
\input{z-Gaussian-processes.tex}
...
\bibliography{Bickel-Freedman-Bootstrap-Asymptotics}
