...
& = &
    \dfrac{
        ...
        \rho_{k}
        \left(\,y^{\prime}_{k} - \widehat{\mu}^{\prime}_{k}\,\right)^{2}
        }{
        \underset{l\,\in\,\textnormal{MOD}(c)}{\sum}\;
        \rho_{k}\cdot\nu_{k}
        }
\end{eqnarray*}
...
& = &
    \alpha_{k}^{2}\cdot\nu_{k}\cdot
    \dfrac{
        \underset{k\,\in\,\textnormal{MOD}(c)}{\sum}\;
        \omega^{\textnormal{MOD}}_{k}
        \left(\,\dfrac{y_{k}}{\alpha_{k}} - \dfrac{\widehat{\mu}_{k}}{\alpha_{k}}\,\right)^{2}
        }{
        \underset{k\,\in\,\textnormal{MOD}(c)}{\sum}\;
        \omega^{\textnormal{MOD}}_{k}\cdot\nu_{k}
        }
\end{eqnarray*}
