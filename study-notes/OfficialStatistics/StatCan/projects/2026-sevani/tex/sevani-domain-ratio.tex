...
\label{ProbabilisticFrameworkDomainRatio}
...
\item
    ...
    and
    \,$(\,\Sdot\,,\Rdot\,)$\,
    are {\color{red}conditionally independent} given \,$\Xdotdot$.
\item
...
in Subsection \ref{ProbabilisticFrameworkDomainRatio}.
\vskip 0.2cm
\noindent
...
\dbullet
$\,
satisfy the probabilistic assumptions specified in Subsection \ref{ProbabilisticFrameworkDomainRatio}.
\vskip 0.2cm
\noindent
Then,
\begin{eqnarray*}
...
\item
    If
    \,$v(\,s\,;y_{\bullet}\,)$\,
    is taken to be the {\color{red}approximately} design-unbiased linearization-based estimator
    for the sampling variance (see Result 5.6.2, p.178, \cite{Sarndal1992}), i.e.,
    \begin{eqnarray*}
    v(\,s\,;y_{\bullet},z_{\bullet}\,)
    & := &
        \dfrac{1}{
            \overset{{\color{white}.}}{\widehat{T}_{z}(s)^{2}}
            }
        \cdot
        \underset{k \in s}{\sum}\,
        \underset{l \in s}{\sum}\;
        ...
        \left(\,
            ...
            \left(\,
                ...
                \dfrac{
                    ...
                    \overset{{\color{white}.}}{\widehat{T}_{z}(s)}
                    }
                \cdot
                z_{k}
                \,\right)
    ...
    % \;\;\; = \;\;\;
    %     v(\,s\,;\,\widetilde{y}_{\bullet},z_{\bullet}\,)
    %     \;+\;
    %     \dfrac{
    %         \underset{k \in s_{M}}{\sum}\;
    %         d_{k}\left(1-\pi_{k}\right)w_{k}^{2}\,\sigma_{k}^{2}
    %         }{
    %         \left(\;
    %             \underset{k \in s}{\sum}\;d_{k}\,w_{k}\,z_{k}
    %             \,\right)^{\!2}
    %         }
    % \\
    % & = &
    %     \dfrac{1}{
    %         \overset{{\color{white}.}}{\widehat{T}_{z}^{2}}
    %         }
    %     \cdot
    %     \underset{k \in s}{\sum}\,
    %     \underset{l \in s}{\sum}\;
    %     \dfrac{\pi_{kl} - \pi_{k}\pi_{l}}{\pi_{kl}}\,
    %     % \left(\,\dfrac{d_{k}(y_{k}-\widehat{R}z_{k})}{\pi_{k}}\,\right)
    %     % \left(\,\dfrac{d_{l}(y_{l}-\widehat{R}z_{k})}{\pi_{l}}\,\right)
    %     \left(\,
    %         \dfrac{d_{k}}{\pi_{k}}
    %         \left(\,
    %             {\color{red}\widetilde{y}_{k}}
    %             \, - \,
    %             \dfrac{
    %                 \widehat{T}(s\,;{\color{red}\widetilde{y}_{\bullet}})
    %                 }{
    %                 \overset{{\color{white}.}}{\widehat{T}_{z}(s)}
    %                 }
    %             \cdot
...
\item
    ...
    & = &
        E_{Y}\!\left[\,
            ...
            \,\right],
    \;\;
    \textnormal{by hypothesis on \,$v(\,s\,;y_{\bullet},z_{\bullet}\,)$}
    \end{eqnarray*}
\item
    ...
    & = &
        ...
        E_{Y_{M}}\!\left[\;
            Y_{a}\,Y_{b}
            \,\left\vert\,
                \YsubR \overset{{\color{white}1}}{=} y_{R},\Xobs
            \right.
            \;\right]
    \\
    & = &
...
\label{NonresponseVarianceDomainRatio}
\mbox{}
\vskip 0.1cm
\noindent
Let
...
\item
    ...
    \Var_{Y}\!\left[\,
        ...
        \,\right]
    \;\; = \;\;
        \left(\,\dfrac{1}{ \overset{{\color{white}.}}{\widehat{T}_{Z}} }\,\right)^{\!2}
        \cdot
        \left(\;
            \underset{l \in s_{R}}{\sum}
                \left(W^{(+)}_{l}\right)^{2}\sigma_{l}^{2}
    ...
    E_{Y}\!\left[\,
        ...
        \,\right]
    \;\; = \;\;
        \left(\,\dfrac{1}{ \overset{{\color{white}.}}{\widehat{T}_{Z}} }\,\right)
        \cdot
        \left(\;
            W^{(+)}_{0}
            \,\;+\;
