...
\vskip 0.5cm
\subsection{Unbiased estimator for the sampling component of
...
\vskip 0.5cm
\subsection{Unbiased estimator for the non-response component of
\,$\MSE\!\left(\,\widetilde{T}_{Y}\left\vert\,\Xobs\right.\right)$}

        %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\begin{lemma}[Unbiased estimator for non-response variance; see Equations (5.9) \& (5.10) in \cite{Beaumont2011}]
