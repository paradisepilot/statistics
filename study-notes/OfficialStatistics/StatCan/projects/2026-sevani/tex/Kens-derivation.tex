...
\item
    $\left(\,\Ydot\,,\Xobs\,\right)$\, and \,$\Sdot$\, are (unconditionally) independent.
\item
    $\Ydot$\, and \,$(\,\Sdot\,,\Rdot\,)$\, are {\color{red}conditionally independent} given \,$\Xobs$.
\end{itemize}
...
\;\; = \;\;
    \underset{i\,\in\,U}{\sum}\;w_{i}\,S_{i}\left(\,
        R_{i}\,Y_{i}
        \overset{{\color{white}.}}{+}
        (1-R_{i})\,Y^{*}_{i}
        \,\right)
...
\;\; = \;\;
    \underset{i\,\in\,U}{\sum}\;w_{i}\,S_{i}\,R_{i}\,Y_{i}
    \;\overset{{\color{white}.}}{+}\;
    \underset{i\,\in\,U}{\sum}\;w_{i}\,S_{i}\,(1-R_{i})\,Y^{*}_{i}
\\
& = &
    {\color{red}
    \underset{i\,\in\,U}{\sum}\;w_{i}\,S_{i}\,Y_{i}
...
& = &
    \underset{i\,\in\,U}{\sum}\;w_{i}\,S_{i}\,Y_{i}
    \;\overset{{\color{white}.}}{-}\;
    \underset{i\,\in\,U}{\sum}\;w_{i}\,S_{i}\,(1-R_{i})\,Y_{i}
    \;\overset{{\color{white}.}}{+}\;
    \underset{i\,\in\,U}{\sum}\;w_{i}\,S_{i}\,(1-R_{i})\,Y^{*}_{i}
\\
& = &
...
\vskip 0.5cm
\begin{lemma}[$\widetilde{T}_{Y} - \widehat{T}_{Y}$ as sum of conditionally indepdent summands;\, see Equation (5.8) in \cite{Beaumont2011}]
...
\;\; := \;\;
    \left(\;
        \overset{J}{\underset{j=1}{\sum}}\;
        \underset{l \in s_{m}^{(j)}}{\sum}\,w_{l}\,d_{l}\,\varphi^{(j)}_{{\color{red}k}l}
        \,\right)
\end{equation*}
...
\vskip 0.5cm
\begin{lemma}[Formula for non-response variance; Equations (5.9) \& (5.10) in \cite{Beaumont2011}]
...
\item
    ...
    E_{Y}\!\left[\,
        ...
        \,\right]
    $\,
    is an unbiased estimator for the non-response variance\\
    \,$
    E_{SR}\!\left[\,
    E_{Y}\!\left[\,
        \left.
...
\item
    Nothing to prove.
\item
    First, recall that, in general, we have:
    \begin{equation*}
    \Var[\,X\,]
    \; := \;
