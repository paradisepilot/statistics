...
\vskip 0.5cm
\begin{lemma}[Handy formula for \,$\widetilde{T}_{Y} - \widehat{T}_{Y}$;\, see Equation (5.8) in \cite{Beaumont2011}]
\mbox{}
\vskip 0.1cm
\noindent
Let \,$s \subset U = \{1,2,\ldots,N\}$\, and \,$s_{R} \subset s$\, be given.
\vskip 0.1cm
\noindent
