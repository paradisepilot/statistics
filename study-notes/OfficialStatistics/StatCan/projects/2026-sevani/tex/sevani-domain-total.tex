...
\subsection{Probabilistic framework of SEVANI \cite{Beaumont2011}}\label{DomainTotalProbabilisticFramework}
...
\dbullet
$\,
satisfy the probabilistic assumptions specified in Subsection \ref{DomainTotalProbabilisticFramework}.
\vskip 0.2cm
\noindent
