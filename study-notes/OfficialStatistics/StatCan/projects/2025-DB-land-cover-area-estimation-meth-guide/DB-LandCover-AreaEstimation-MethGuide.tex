...
\rhead[Methodology Guide (Release 2025/03/27)]{CoE/EASD/StatCan}
\lhead[CoE/EASD/StatCan]{Methodology Guide (Release 2025/03/27)}
\chead[]{{\Large\bf Design-based Land Cover Area Estimation} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\vskip 1.5cm \input{tex/target-period-target-variables}
\vskip 1.0cm \input{tex/sampling}
\vskip 1.0cm \input{tex/generation-of-reference-data}
\vskip 1.0cm \input{tex/estimation}
\vskip 1.0cm \input{tex/quality-indicators}
