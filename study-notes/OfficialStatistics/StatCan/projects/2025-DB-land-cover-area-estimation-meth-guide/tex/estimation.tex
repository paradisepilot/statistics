...
we computed the desired (and reported) estimate \,$A_{p}^{(r)}$\,
for the area of reference land cover type \,$r$\, within the ecoprovince \,$p$\, as follows:
...
for the reference land cover type \,$r$\, within ecoprovince \,$p$\, is simply the sum of 
...
Lastly, for each ecoprovince \,$p$,\, the desired estimates
\,$A_{p}^{(r)}$’s\,
