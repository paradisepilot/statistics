...
\vskip 0.1cm
\mbox{}
\includegraphics[width=4.25in,clip,trim={20 65 5 75}]{\graphicsDir/plot-stratified-sample}
\vskip 0.01cm
\begin{minipage}{4.25in}
{\small A visualization of the distribution of the selected sampling units,
which are indicated as yellows dots.
Ecoprovince boundaries are indicated in blue.}
\end{minipage}
\end{center}
