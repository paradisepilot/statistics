...
\normalsize
\vskip 0.6cm
\onslide<4->{Les \,$\Gamma_{i}$\, s'appellent les \textbf{variables de comparaison}.}
\vskip 0.3cm
\onslide<5->{Elles sont toutes cat\'egorielles, mais pas n\'ecessairement binaires.}
\vskip 0.2cm
\onslide<6->{\scriptsize p. ex. \;\,$\Gamma_{i}$ \,$=$\,
	1 (pleinement d'accord),
	2 (partiellement d'accord),
	\vskip 0.0cm
	\mbox{}\;3 (pas du tout d'accord),
	4 (manquant)}
\end{center}
...
\hline
	...
	&
	&
	\onslide<8->{Lien, $\overset{{\color{white}.}}{\widehat{M}}$}
	\\
...
\begin{center}
\vskip 0.1cm
\onslide<5->{On a besoin d'un mod\`ele statistique pour estimer
\vskip 0.025cm
