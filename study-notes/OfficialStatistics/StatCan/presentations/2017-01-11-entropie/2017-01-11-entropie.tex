...
\vskip 2.5cm
\textbf{\huge\color{titlefontblue}Qu'est-ce que}
\vskip 0.1cm
\resizebox{0.75\linewidth}{!}{\color{titlefontblue}\bf\itshape l'entropie}
\vskip 0.1cm
\textbf{\huge\color{titlefontblue}mange en hiver ?}
...
\textbf{\color{titlefontcolour}12 avril 2017} 
