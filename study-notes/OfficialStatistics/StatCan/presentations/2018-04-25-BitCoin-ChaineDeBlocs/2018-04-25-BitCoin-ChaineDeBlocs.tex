...
\vskip 0.2cm
\textbf{\color{titlefontcolour}25 avril 2018} 
...
\input{z-bitcoin-pizza}
\input{z-petite-difference}
\input{z-blockchain-info}
\input{z-bitcoin-mining-flowchart}
\input{z-comment-creer-un-nouveau-bloc}
\input{z-bitcoin-est-securise}

\input{z-contact}

%%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%
\appendix
\input{z-blockchain-blocs}
