...
y <- scale(b0 + b1 * x + rnorm(length(x),0,0.1));
...
my.ggplot <- my.ggplot + scale_x_continuous(limits=1.05*c(-1,1),breaks=seq(-1,1,0.2));
...
myPlot.LASSO(
    ...
    DF.valid    = DF.valid,
    lambda      = 1,
    FILE.output = 'xy-LASSO-fit-lambda-1.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-10.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-100.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-200.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-300.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-400.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-450.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-500.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-550.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-600.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-650.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-700.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-750.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-850.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-1200.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-1500.png'
    );
...
myPlot.LASSO(
    ...
    DF.train    = DF.train,
    DF.valid    = DF.valid,
    FILE.output = 'xy-LASSO-fit-lambda-3000.png'
    );
