...
\chead[]{{\Large\bf Model-inspired Regression Estimator (Survey Sampling Theory)} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\mbox{}\vskip 0.0cm
\input{z-regressionEstimator}

\clearpage
\input{z-groupRatioYieldsPoststratifiedRatioEstimator}

\clearpage
\input{z-groupMeanYieldsPoststratifiedEstimator}

\clearpage
\input{z-commonRatioYieldsRatioEstimator}

\clearpage
\input{z-commonMeanYieldsExpandedSampleMean}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\clearpage
\appendix
\input{z-covarianceHorvitzThompsonEstimator}
\input{z-varianceLinearCombinationHTEstimators}
...
\bibliography{model-inspired-regressionEstimator-StudyNotes}
