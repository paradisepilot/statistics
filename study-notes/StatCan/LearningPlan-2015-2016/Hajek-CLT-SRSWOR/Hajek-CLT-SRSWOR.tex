...
\begin{theorem}[The H\'ajek Central Limit Theorem for SRSWOR \cite{Hajek1960}]
...
\vskip 0.5cm
\proofof \textbf{Theorem \ref{HajekCLTSRSWOR} (The H\'ajek Central Limit Theorem for SRSWOR \cite{Hajek1960}).}
\vskip 0.2cm
\noindent
Let $\left\{\,U_{\nu}\,\right\}_{\nu\in\N}$, $\left\{\,n_{\nu}\,\right\}_{\nu\in\N}$, and
