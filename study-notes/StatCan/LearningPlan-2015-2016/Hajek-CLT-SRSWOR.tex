...
Hence,
\begin{eqnarray*}
E\!\left[\;\left.\left(X^{(0)} - X^{(1)}\right)\;\right\vert\;\left\vert\,s^{(1)}\,\right\vert = k\;\right]
&=& \dfrac{\vert\,k-n\,\vert}{n}\cdot E\!\left[\;\widehat{\overline{T}}^{\mbox{}\,\textnormal{HT}}_{\mbox{}\,\textnormal{SRSWOR}}\;\right]
\;\;=\;\; 0
\end{eqnarray*}
Hence,
\begin{eqnarray*}
E\!\left[\;\left.\left(X^{(0)} - X^{(1)}\right)^{2}\;\right\vert\;\left\vert\,s^{(1)}\,\right\vert = k\;\right]
&=& \Var\!\left[\;\left.X^{(0)} - X^{(1)}\;\right\vert\;\left\vert\,s^{(1)}\,\right\vert = k\;\right]
\\
&=&
...
Consequently,
\begin{eqnarray*}
E\!\left\{\;\left(X^{(0)} - X^{(1)}\right)^{2}\;\right\}
&=& E\!\left\{\;E\!\left[\;\left.\left(X^{(0)} - X^{(1)}\right)^{2}\;\right\vert\;\left\vert\,s^{(1)}\,\right\vert = k\;\right]\;\right\}
\\
...
Next, we compute $\Var\!\left[\,X^{(1)}\,\right]$.
To this end, note that
\begin{equation*}
X^{(1)} \; = \; \sum_{i\in U}\,Z_{i},
\end{equation*}
...
Thus,
\begin{equation*}
\Var\!\left[\,Z_{i}\,\right] \; = \; \left(\dfrac{y_{i} - \overline{y}}{n}\right)^{2}\cdot\dfrac{n}{N}\left(1 - \dfrac{n}{N}\right),
\end{equation*}
which in turn imples
\begin{equation*}
\Var\!\left[\,X^{(1)}\,\right]
\;\;=\;\; \sum_{i\in U}\,\Var\!\left[\,Z_{i}\,\right]
\;\;=\;\; \sum_{i\in U}\,\left(\dfrac{y_{i} - \overline{y}}{n}\right)^{2}\cdot\dfrac{n}{N}\left(1 - \dfrac{n}{N}\right)
\;\;=\;\; \cdots
\;\;=\;\; \dfrac{1}{n^{2}}
\dfrac{\underset{i\in U}{\sum}\left(y_{i}-\overline{y}_{U}\right)^{2}}{N}
