...
\vskip 3.25cm
\textbf{\huge\color{titlefontblue}Linkage-error-adjusted}
\vskip 0.15cm
\resizebox{0.75\linewidth}{!}{\color{titlefontblue}\bf\itshape Logistic Regression}
\vskip 0.15cm
\textbf{\huge\color{titlefontblue} via Clerical Review}
...
\vskip 0.2cm
\textbf{\color{titlefontcolour}May 29, 2017} 
...
\input{z-classicalLogisticRegression}
\input{z-Chipperfield-logisticRegression}

%\input{z-qu-est-cest}
%\input{z-pertinence-nest-pas-suffisante}
%\input{z-PageRank}
\input{z-thanks}
