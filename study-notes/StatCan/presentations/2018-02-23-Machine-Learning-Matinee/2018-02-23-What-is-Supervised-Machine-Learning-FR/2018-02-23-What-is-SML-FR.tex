...
\vskip 2.75cm
\textbf{\LARGE\color{titlefontblue}Qu'est-ce que}
\vskip 0.15cm
\resizebox{1.0\linewidth}{!}{\color{titlefontblue}\bf\itshape l'Apprentissage automatique}
\resizebox{0.375\linewidth}{!}{\color{titlefontblue}\bf\itshape supervis\'{e}?}
\vskip 0.10cm
\textbf{\small\color{titlefontblue}pr\'evision, sous-apprentissage, surapprentissage,\\
optimisation d'hyperparam\`etres via validation crois\'ee, et\vskip -0.05cm une s\'equence de travail g\'en\'erique}
...
\vskip 0.15cm
\textbf{\color{titlefontcolour}23 f\'{e}vrier 2018} 
