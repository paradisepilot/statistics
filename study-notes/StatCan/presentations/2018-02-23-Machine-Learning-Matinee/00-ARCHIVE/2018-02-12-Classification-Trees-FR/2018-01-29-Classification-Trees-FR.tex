...
\vskip 2.75cm
\resizebox{0.80\linewidth}{!}{\color{titlefontblue}\bf\itshape Les arbres de}
\vskip 0.15cm
\resizebox{0.87\linewidth}{!}{\color{titlefontblue}\bf\itshape classification}
...
\vskip 0.2cm
\textbf{\color{titlefontcolour}23 f\'evrier 2018} 
...
\input{z-overview}
\input{z-iris}
\input{z-optimization-problem}
\input{z-hypothesis-class}
\input{z-objective-function}
\input{z-CART-algorithm}
\input{z-strengths-weaknesses}
\input{z-horizontal-diagonal}

%\input{z-thanks}
\input{z-contact-info}
