...
\vskip -0.15cm
\onslide<4->{r\'eduit le nombre de param\`etres \og$M=1$\fg\;(probabilit\'es conditionnelles) {\color{red}de $3$ \`a $2$}.}\\
\onslide<5->{De la m\^eme fa\c{c}on, elle r\'eduit le nombre de param\`etres \og$M=0$\fg\;de $3$ \`a $2$.}
...
\onslide<6->{\#(\,param\`etres d'observations\,) $=$ $2^{2}-1$ $=$ $3$}
\onslide<11->{\;\;$<$\;\;}
\onslide<11->{$5$ $=$}
\onslide<10->{$1\,+$}
\onslide<8->{$2\,\times$\!}
\onslide<9->{$(2)$}
\onslide<8->{$=$}
\onslide<7->{\#(\,param\`etres de mod\`ele\,)}

\vskip 0.15cm

\textbf{\normalsize
	\onslide<12->{Non-identifiable toujours,}
	\onslide<13->{avec 2 variables de comparaison !}
	\vskip 0.13cm
	\onslide<14>{Qu'est-ce qui se passe avec 3 ?}
	}
...
$=$ $1+2 \times\!(3)$ $=$ \onslide<2->{\#(\,param\`etres de mod\`ele\,)}
\end{center}
...
%\pause\large\#(\,{\small param\`etres}\,) $>$ \#(\,{\small comptes observ\'es}\,) \;$\Rightarrow$\; {\small non-identifiabilit\'e}
%\vskip 0.2cm
%\pause\large\#(\,{\small param\`etres}\,) $\leq$ \#(\,{\small comptes observ\'es}\,) \;$\not\Rightarrow$\; {\small{\color{white}non-}identifiabilit\'e}}
\pause
\vskip 0.7cm
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{frame}{\large \#(\,{\large param\`etres}\,) $\leq$ \#(\,{\large comptes observ\'es}\,) \,$\not\Rightarrow$\, \large %identifiabilit\'e}
\begin{frame}{\vskip -0.2cm\small{\Large\#\scriptsize$\left(\!\begin{array}{c}\textbf{param\`etres} \\ \textbf{de mod\`ele}\end{array}\!\right)$}
\;\;$\leq$\;\;
{\Large\#\scriptsize$\left(\!\begin{array}{c}\textbf{param\`etres} \\ \textbf{d'observations}\end{array}\!\right)$}
\LARGE\;\;$\not\Rightarrow$\;\;
...
\hline
	\rowcolor{customRed}
	\cellcolor{white}\#(\,param\`etres d'observations) & \cellcolor{pink}3 & \cellcolor{white}7 & 11 & 14 & 17 & 20 \\
\hline
	\rowcolor{customRed}
	\cellcolor{white}\#(\,param\`etres de mod\`ele\,) & \cellcolor{pink}5 & \cellcolor{white}7 & 11 & 13 & 15 & 17 \\
\hline
	\rowcolor{lightGray}``effective dimension'' & & & 9 & 11 & 13 & 15 \\
\hline
\hline
identifiable & Non & \alt<3>{\cellcolor{lightGreen}Oui$^{\ddag}$}{?} & \onslide<2->{Non$^{\dagger}$} & \onslide<2->{Non$^{\dagger}$} & \onslide<2->{Non$^{\dagger}$} & \onslide<2->{Non$^{\dagger}$} \\
\hline
\end{tabular}
\end{center}
