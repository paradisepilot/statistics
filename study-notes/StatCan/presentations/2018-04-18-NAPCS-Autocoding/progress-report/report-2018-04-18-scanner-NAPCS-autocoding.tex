...
%\usepackage{pgffor}
%\usepackage[linkbordercolor={1 1 1},colorlinks=true,linkcolor=blue,citecolor=black]{hyperref}
...
\rhead[Progress Report]{Kenneth Chu}
\lhead[Kenneth Chu]{ICCSMD, Statistics Canada}
\chead[]{{\Large\bf Retailer Scanner Data NAPCS Autocoding, Methodology Review} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\newcommand{\mySum}{\underset{i=1}{\overset{n}{\textnormal{\large$\sum$}}}}
\newcommand{\sigmaW}{\mySum w_{i}}
\newcommand{\sigmaWX}{\mySum w_{i}x_{i}}
\newcommand{\sigmaWY}{\mySum w_{i}y_{i}}
\newcommand{\sigmaWXtwo}{\mySum w_{i}x_{i}^{2}}
\newcommand{\sigmaWXY}{\mySum w_{i}x_{i}y_{i}}
\newcommand{\sigmaWYtwo}{\mySum w_{i}y_{i}^{2}}
...
\clearpage
\input{z-structure-RetailerA-scanner-data}
\input{z-structure-RetailerA-concordance-table}
\input{z-X12345-almost-determine-Y}
\input{z-structure-RetailerB-scanner-data}
\mbox{}\vskip 0.5cm
\input{z-accuracy-results}
\mbox{}\vskip 0.5cm
\input{z-conclusions}
...
%\clearpage
\appendix
\input{z-supplementary-materials}
%\input{z-aggregate-results.tex}
%\input{z-EDR-results.tex}
%\input{z-nonEDR-results.tex}
%\input{z-corOne-results.tex}
...
\bibliography{report-2018-04-18-scanner-NAPCS-autocoding}
