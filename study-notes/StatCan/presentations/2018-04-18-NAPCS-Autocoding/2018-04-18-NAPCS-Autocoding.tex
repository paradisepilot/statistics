...
\vskip 2.75cm
\resizebox{0.80\linewidth}{!}{\color{titlefontblue}\bf\itshape Review of \,ESD's prototype module for}
\vskip 0.1cm
\resizebox{0.90\linewidth}{!}{\color{titlefontblue}\bf\itshape Retailer Scanner Data}
\vskip 0.3cm
\resizebox{0.80\linewidth}{!}{\color{titlefontblue}\bf\itshape NAPCS Autocoding}
...
\vskip 0.2cm
\textbf{\color{titlefontcolour}April 18, 2018} 
...
\input{z-data-structure-Retailer-A}
\input{z-data-structure-Retailer-B}
\input{z-NAPCS-autocoding-workflow-diagram}
