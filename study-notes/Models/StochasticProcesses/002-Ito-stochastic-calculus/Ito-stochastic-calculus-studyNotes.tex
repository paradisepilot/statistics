...
\chead[]{{\Large\bf It\^{o} Stochastic Calculus} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-wiener-process}

\clearpage
\input{z-wiener-process-increments}

\clearpage
\input{z-wiener-process-martingales}

\clearpage
\input{z-wiener-process-sample-paths}

%\vskip 0.5cm
%\input{z-Ito-stochastic-integral}
