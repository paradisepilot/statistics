...
\item
	...
	& \leq &
		...
		\textnormal{by Proposition \ref{MTwoIsNormedVectorSpace}},
	\end{eqnarray*}
	which readily implies that the ``interlaced'' sequence
	\,$h_{1} := f_{1},\, h_{2} := g_{1},\, h_{3} := f_{2},\, h_{4} := g_{2},\;\ldots$\; is also a Cauchy sequence in
	\,$L^{2}(\Omega,\mathcal{A},\mu)$,\, admitting the original two sequences as subsequences.
	This implies that
	\begin{equation*}
	f_{\star} \; = \; h_{\star} \; = \; g_{\star}\,,
	\end{equation*}
	where \,$h_{\star}$\, is the limit of \,$h_{1}, h_{2}, \,\ldots$\; in \,$L^{2}(\Omega,\mathcal{A},\mu)$.\,
	This proves Claim 2.
