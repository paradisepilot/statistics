...
\vskip 0.5cm
\begin{proposition}[The It\^{o} isometry for stochastic step processes]
...
\item
	...
	\vskip 0.5cm
	\textbf{Claim 2:}\quad
	$f_{\star} \in L^{2}(\Omega,\mathcal{A},\mu)$\, in Claim 1 is fully determined by \,$f$,\, and
	independent of the specific choice of the the sequence \,$f_{1}, f_{2},\;\ldots$
	\vskip 0.2cm
	\noindent
	Proof of Claim 2:\quad
	Suppose \,$g_{1}, g_{2}, \,\ldots$\; is another sequence of stochastic step processes
	approximating \,$f$,\, and \,$g_{\star}$\, is its limit in \,$L^{2}(\Omega,\mathcal{A},\mu)$.\,
	We need to show that \,$f_{\star} \, = \, g_{\star}$.\,
	To this end, observe that
	\begin{eqnarray*}
	\left\Vert\; I(f_{m}) \overset{{\color{white}.}}{-} I(g_{n}) \,\right\Vert_{L^{2}(\Omega,\mathcal{A},\mu)}
	& = &
		\left\Vert\; I(f_{m} \overset{{\color{white}.}}{-} g_{n}) \,\right\Vert_{L^{2}(\Omega,\mathcal{A},\mu)},
		\quad
		\textnormal{by linearity of \,$I(\,\cdot\,)$\, on stochastic step processes}
	\\
	& = &
		\left\Vert\; f_{m} \overset{{\color{white}.}}{-} g_{n} \;\right\Vert_{M^{2}},
		\quad
		\textnormal{by Proposition \ref{ItoIsometryForStepProcesses}}
	\\
	& \leq &
		\left\Vert\; f_{m} \overset{{\color{white}.}}{-} f \;\right\Vert_{M^{2}}
		\; + \;
		\left\Vert\; f \overset{{\color{white}.}}{-} g_{n} \;\right\Vert_{M^{2}},
		\quad
		\textnormal{by Proposition \ref{MTwoIsNormedVectorSpace}},
	\end{eqnarray*}
	which readily implies that the images under \,$I(\,\cdot\,)$\, of the elements of the ``interlaced'' sequence
	\,$h_{1} := f_{1},\, h_{2} := g_{1},\, h_{3} := f_{2},\, h_{4} := g_{2},\;\ldots$\; also form a Cauchy sequence in
	\,$L^{2}(\Omega,\mathcal{A},\mu)$,\, which admits the original two sequences as subsequences.
	This implies that
	\begin{equation*}
	f_{\star} \; = \; h_{\star} \; = \; g_{\star}\,,
	\end{equation*}
	where \,$h_{\star}$\, is the limit of \,$I(h_{1}), I(h_{2}), \,\ldots$\; in \,$L^{2}(\Omega,\mathcal{A},\mu)$.\,
	This proves Claim 2.
