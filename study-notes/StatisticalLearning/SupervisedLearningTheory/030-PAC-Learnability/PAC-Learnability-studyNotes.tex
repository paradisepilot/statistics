...
\chead[]{{\Large\bf PAC Learnability \& Agnostic PAC Learnability} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-PAC-Learnability}

\clearpage
\input{z-Finite-hypothesis-classes-are-PAC-learnable}

%\clearpage
%\input{z-BayesClassifier-Optimality}

%\clearpage
%\input{z-consistency-notions}
...
%\bibliography{PAC-Learnability-studyNotes}
