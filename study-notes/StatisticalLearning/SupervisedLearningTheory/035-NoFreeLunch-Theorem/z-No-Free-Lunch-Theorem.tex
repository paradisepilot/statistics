...
Now, note that, by construction of \,$g_{i}$\, and \,$\mathcal{D}_{i}$,\, we have:
\begin{equation*}
P_{\,(X,Y)\,\sim\,\mathcal{D}_{i}}\!\left(\,Y \overset{{\color{white}-}}{=} g_{i}(X)\,\right) \; = \; 1\,,
\quad
\textnormal{for each \,$i \in \{1,2,\ldots,2^{2n}\}$}
\end{equation*}
...
By Corollary \ref{corollary:MarkovInequality},
\begin{equation*}
\overset{{\color{white}\vert}}{P}_{{\color{red}D_{n}}\,\sim\,\mathcal{D}^{\otimes n}}\!\left(\,
	P_{\,(X,Y)\,\sim\,\mathcal{D}}\!\left(\,h({\color{red}D_{n}})(X) \overset{{\color{white}.}}{\neq} Y\,\right) > \dfrac{1}{8}
	\;\right)
\;\; \geq \;\;
	\dfrac{\overset{{\color{white}\vert}}{E}_{{\color{red}D_{n}}\,\sim\,\mathcal{D}^{\otimes n}}\!\left[\;
	P_{\,(X,Y)\,\sim\,\mathcal{D}}\!\left(\,h({\color{red}D_{n}})(X) \overset{{\color{white}.}}{\neq} Y\,\right)
	\;\right] \,-\, 1/8}{1 \,-\, 1/8}
\end{equation*}
Claim 2 then implies
\begin{equation*}
\overset{{\color{white}\vert}}{P}_{{\color{red}D_{n}}\,\sim\,\mathcal{D}^{\otimes n}}\!\left(\,
	P_{\,(X,Y)\,\sim\,\mathcal{D}}\!\left(\,h({\color{red}D_{n}})(X) \overset{{\color{white}.}}{\neq} Y\,\right) > \dfrac{1}{8}
	\;\right)
