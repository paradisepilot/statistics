...
\chead[]{{\Large\bf Plug-in Classifiers and Plug-in Classification Rules} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-Plug-In-Classifiers}

\clearpage
\input{z-Plug-In-ClassificationRules}
...
\bibliography{Plug-In-Classifiers-studyNotes}
