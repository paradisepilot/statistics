...
\item
	...
	\begin{itemize}
	\item
		the individual scores always simply just add back up to the population score, and
	\item
		all interactions among the players are taken into account.
	\end{itemize}
	...
	the coalition-level score to the individual players in a ``natural'' manner).
	...
	the {\color{red}interactions} among all players by,
...
\item
	...
	\item
		...
		as the ``{\color{red}contribution}'' %on top of the mean prediction $A_{0}(f)$
