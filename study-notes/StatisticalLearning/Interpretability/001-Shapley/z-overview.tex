...
\item
	...
	\item
		...
		\vskip 0.2cm
		\textbf{Thus, the feature-specific contribution score $R_{i}(x;f)$ can be interpreted
...
\item
	Returning to \v{S}trumbelj-Kononenko \cite{Strumbelj2010}:
	...
	\item
		...
		\; = \;
			...
			\end{array}\right.
		\end{equation*}
		However, we refer the reader to \cite{Strumbelj2010} for full mathematical details;
		in particular, the definition of $\mathcal{F}_{U\,\backslash S}$ above.
