...
\chead[]{{\Large\bf Interpreting Predictive Models via Shapley Additive Decomposition} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-overview}
\clearpage
\input{z-Shapley-Decomposition}
%\input{z-general-vectorial-form}
%\clearpage
%\input{z-multi-layer-perceptron}
