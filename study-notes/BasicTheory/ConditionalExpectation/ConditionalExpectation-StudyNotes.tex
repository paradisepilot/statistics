...
\chead[]{{\Large\bf Conditional Expectation} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\mbox{}\vskip 0.0cm
\input{z-conditionalExpectation-existence}
\input{z-conditionalExpectation-properties}
...
\bibliography{ConditionalExpectation-StudyNotes}
