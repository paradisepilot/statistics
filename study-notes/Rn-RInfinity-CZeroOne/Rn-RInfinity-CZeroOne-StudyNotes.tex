...
\chead[]{{\Large\bf Separating and convergence-determining classes of $\Re^{n}$, $\Re^{\infty}$ and $C\!\left([0,1],\Re\right)$} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-separating-convergence-determining.tex}
\input{z-RInfinity.tex}
\input{z-C01.tex}
...
\input{z-sigma-algebras.tex}
\input{z-topology.tex}
\input{z-PortmanteauTheoremAndCorollaries.tex}
...
\bibliography{Rn-RInfinity-CZeroOne-StudyNotes}
