...
Suppose:
\begin{itemize}
\item	$\{\,k_{n}\,\}_{n\in\N}\subset\N$ is a sequence of natural numbers, and %such that $k_{n} \rightarrow \infty$ as $n \rightarrow \infty$, and
...
\begin{theorem}[Lyapunov's Central Limit Theorem]
\mbox{}\vskip 0.2cm
\noindent
Suppose:
\begin{itemize}
