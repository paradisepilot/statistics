...
\chead[]{{\Large\bf Asymptotics of Estimating Equations} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-M-estimators-consistency}
%\input{z-Estimating-Equations}
%\input{z-StrongLawOfLargeNumbers}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

%\appendix
%\clearpage\input{z-operator-norm}
%\clearpage\input{z-uniform-convergence-probability-one}
%\clearpage\input{z-generalization-InverseFunctionTheorem}
%\clearpage\input{z-technicalLemmas}
...
\bibliography{GeneralizedEstimatingEquations-studyNotes}
