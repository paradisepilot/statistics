...
\chead[]{{\Large\bf (Outer) Weak Convergence} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-OuterWeakConvergence}
\input{z-UniquenessWeakLimits}

\clearpage
\input{z-PortmanteauTheorem}

\clearpage
\input{z-MappingTheorem}

\clearpage
\input{z-ProkhorovTheorem}

%\input{z-Outer-Jensen-Inequality}
%\input{z-Outer-Chebyshev-Inequality}
%\input{z-Outer-Monotone-Convergence}
%\input{z-Outer-Dominated-Convergence}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\clearpage
\appendix
\input{z-TopologicalPropertiesOfMetricSpaces}
\input{z-MeasureTheoreticPropertiesOfMetricSpaces}
\clearpage
%\input{z-Daniell-Stone-RepresentationTheorem}
\input{z-sigma-algebras}
\input{z-separatingClasses}
...
\bibliography{WeakConvergence-studyNotes}
