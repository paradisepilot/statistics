...
\item
	\textbf{Claim 1:}\quad
	There exist $\delta > 0$ and $M > 0$ such that
	\begin{equation*}
	\underset{x\,\in\,\overline{B}_{\delta}(x^{\star})}{\sup}\,
	...
	we may choose $\varepsilon > 0$ such that $B_{\varepsilon}(x^{\star}) \subset \Omega$
	and $\nabla g(x)$ is non-singular for each $x \in B_{\varepsilon}(x^{\star})$.
	Next, choose $\delta > 0$ such that $0 < \delta < \varepsilon$.
	By compactness of $\overline{B}_{\delta}(x^{\star})$ and continuity of
	$(\,\nabla g\,)^{-1}$ on $\overline{B}_{\delta}(x^{\star})$, we have
	\begin{equation*}
	\underset{x\,\in\,\overline{B}_{\delta}(x^{\star})}{\sup}\,
	\left\Vert\;\left(\,\nabla g(x)\,\right)^{-1}\,\right\Vert
	\;\; < \;\; \infty\,.
	...
	\noindent
	\textbf{Claim 2:}\quad
	For each $x \in \overline{B}_{\delta}(x^{\star})$, we have
	\begin{equation*}
	g(x)
	\;\; = \;\;
		\left(\;
