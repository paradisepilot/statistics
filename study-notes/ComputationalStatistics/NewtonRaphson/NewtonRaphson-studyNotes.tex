...
\chead[]{{\Large\bf The Newton-Raphson Method} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-NewtonRaphson}
\input{z-concavityExponentialFamilyLogLikelihood}
\input{z-logisticRegression}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

%\clearpage
%\appendix
%\input{z-logisticRegression-NewtonRaphson}
