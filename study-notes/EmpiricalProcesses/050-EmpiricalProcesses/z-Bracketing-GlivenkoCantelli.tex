...
\item
	...
	\;\; := \;\;
		...
		\;\;\right\vert\;\,
			...
			%l(x) \leq g(x) \leq u(x)\,,\;\forall\;x\in\D
		\;\right\}.
	\end{equation*}
\item
	For $\varepsilon > 0$, an \underline{\textbf{$\varepsilon$-bracket}{\color{white}j}}
	is a bracket $[\,l,u\,]$, with $l, u \in \mathcal{F}$, such that
	$\Vert\,u-l\,\Vert\,<\,\varepsilon$.
\item
	The \underline{\textbf{bracketing number \,$N_{[\,]}\!\left(\,\varepsilon,\mathcal{F},\Vert\cdot\Vert\,\right)$}}
	is defined as follows:
	\begin{equation*}
	N_{[\,]}\!\left(\,\varepsilon,\mathcal{F},\Vert\cdot\Vert\,\right)
	\;\; := \;\;
		\min\left\{\;
			n \overset{{\color{white}.}}{\in} \N
		\;\;\left\vert\;
			\begin{array}{c}
			\exists\;\;\; l_{1}, u_{1},\; l_{2}, u_{2},\; \ldots\,,\; l_{n}, u_{n} \,\in\, \mathcal{F} \;\;\; \textnormal{such that} \\
			\Vert\,u_{i} - l_{i}\,\Vert < \varepsilon\,, \;\overset{{\color{white}-}}{\forall}\; i = 1,2,\ldots,n\,, \;\;
			\textnormal{and}\;\; \mathcal{F} \,\subset \overset{n}{\underset{i=1}{\bigcup}}\,[\,l_{i},u_{i}\,] \\
			\end{array}
		\right.
		\right\}
	\end{equation*}
