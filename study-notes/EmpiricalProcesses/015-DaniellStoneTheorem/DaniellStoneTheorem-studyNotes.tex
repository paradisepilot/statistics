...
\chead[]{{\Large\bf The Daniell-Stone Representation Theorem} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\mbox{}\vskip 0.0cm
\input{z-elementaryIntegrals-vectorLattices}

\clearpage
\input{z-systemsOfIntervals}
...
\bibliography{DaniellStoneTheorem-studyNotes}
