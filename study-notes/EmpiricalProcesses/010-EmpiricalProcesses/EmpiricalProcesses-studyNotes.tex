...
\chead[]{{\Large\bf Empirical Processes, Glivenko-Cantelli and Donsker Classes} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-EmpiricalProcesses}
%\input{z-Properties-MinimalMeasurableMajorant}
...
%\clearpage
%\appendix
%\input{z-example-nonMeasurable-stochasticProcess}
