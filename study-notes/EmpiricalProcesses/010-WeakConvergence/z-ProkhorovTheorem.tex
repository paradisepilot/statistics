...
\\
&=&
	\underset{i\rightarrow\infty}{\lim}\; E\!\left[\; \left(\;f_{m} \circ X_{n(i)}\,\right)_{*} \,\right]
\\
&=&
	\underset{i\rightarrow\infty}{\lim}\;
	E\!\left[\;
...
E\!\left[\;
	...
	\left(1_{\left\{X_{n(i)} \notin K^{\delta}\right\}}\right)^{*}
\,\right]
\;\leq\; \Vert\,f_{1}\,\Vert_{\infty} \cdot \varepsilon\,.
\end{equation*}
...
\;\; \leq \;\;
	2\,\varepsilon
\end{eqnarray*}
Next, let $C_{n(i)} \,:=\, \left\{X_{n(i)} \notin K^{\delta}\right\}^{*}$.
Recall that, by Lemma 1.2.3(ii), p.9, \cite{vanDerVaart1996},
\begin{equation*}
\left(1_{\left\{X_{n(i)} \notin K^{\delta}\right\}}\right)^{*}
\;\; = \;\;
	1_{\left\{X_{n(i)} \notin K^{\delta}\right\}^{*}}
...
\\
&=&
	\int_{A_{n(i)} \,\cap\, C_{n(i)}}
		\left(\;f_{m} \circ X_{n(i)}\,\right)_{*}
	\;\d\mu_{n(i)}
\\
&=&
	\int_{A_{n(i)} \,\cap\, C_{n(i)}} \Vert\,f_{1}\,\Vert_{\infty} \;\d\mu_{n(i)}
\;\; \leq \;\;
	\Vert\,f_{1}\,\Vert_{\infty} \cdot \varepsilon
\end{eqnarray*}
