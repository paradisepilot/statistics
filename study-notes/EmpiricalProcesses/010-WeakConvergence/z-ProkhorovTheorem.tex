...
\begin{enumerate}
\item
	If \,$\{\,X_{n}\,\}_{n\in\N}$\, is asymptotically measurable, then so is every subsequence of it.
\item
	If \,$\{\,X_{n}\,\}_{n\in\N}$\, is asymptotically tight, then so is every subsequence of it.
\end{enumerate}
\end{proposition}
\proof
\begin{enumerate}
