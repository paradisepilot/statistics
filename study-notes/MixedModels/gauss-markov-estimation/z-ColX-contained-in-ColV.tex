...
\item
	...
	\,$\mathcal{L}_{X \cdot \left(\,X^{T} \cdot V^{\dagger} \cdot X\,\right)^{\dagger} \cdot X^{T} \cdot V^{\dagger}}
	: \Re^{n} \longrightarrow \Re^{n}$\,
	is indeed an linear unbiased estimator of
	\,$\mathcal{L}_{X} : \Re^{p} \longrightarrow \Re^{n}$\,
	in terms of
	\,$Y \,=\, \left\{\,Y_{\beta}\,\right\}$.
	...
	Since $Y_{\beta} \,\in\, \Col(X,V) \,=\, \Col(V)$, we see that
	$Q \cdot Q^{\dagger} \cdot Y_{\beta} \, = \, Y_{\beta}$.
	Furthermore,
	...
	$\mathcal{L}_{\Lambda}$ is an linear unbiased estimator of
