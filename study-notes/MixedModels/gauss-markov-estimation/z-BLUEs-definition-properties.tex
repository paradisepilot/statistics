...
\vskip 1.0cm
\begin{theorem}[Uniqueness of BLUEs, Theorem 10.1.5, p.242, \cite{Christensen2011}]
\label{BLUEuniquness}
\mbox{}\vskip 0.1cm\noindent
Suppose:
\begin{itemize}
\item
	...
	\,$\mathcal{L}_{X} : \Re^{p} \longrightarrow \Re^{n}$ is left multiplication by $X \in \Re^{n \times p}$.
%\item
%	$A_{1},\, A_{2} \in \Re^{n \times n}$\, and 
%	\,$\mathcal{L}_{A_{1}},\, \mathcal{L}_{A_{2}} : \Re^{n} \longrightarrow \Re^{n}$\,
%	are left multiplication by \,$A_{1}, A_{2} \in \Re^{n \times n}$,\, respectively.
\item
	$Y = \left\{\;
		\left.
		\overset{{\color{white}.}}{Y}_{\beta} : (\Omega_{\beta},\mathcal{A}_{\beta},\mu_{\beta}) \longrightarrow \Re^{n}
