...
\begin{theorem}[The Gauss-Markov Theorem: LSE's are BLUE]
\label{GaussMarkovTheoremScalar}
\mbox{}
\vskip 0.1cm
\noindent
Suppose:
...
\item
	...
	is an $X$-estimable $\Re^{1}$-valued function,
	where $\gamma \in \Re^{n}$;
	in other words,
	\begin{equation*}
	\mathcal{L}_{\gamma^{T}} \circ \mathcal{L}_{X}(\,\beta\,) \; = \; \gamma^{T} \cdot X \cdot \beta\,,
...
\begin{equation*}
\mathcal{L}_{\,\gamma^{T}} \circ \mathcal{L}_{\,\Pi_{X}}
\;\; : \;\;
...
\end{equation*}
is a {\color{red}BLUE} (best linear unbiased estimator) of
\,$\mathcal{L}_{\,\gamma^{T}} \circ \mathcal{L}_{X} : \Re^{p} \longrightarrow \Re^{1}$\,
...
\begin{enumerate}
\item
	$\mathcal{L}_{\,\gamma^{T}} \circ \mathcal{L}_{\,\Pi_{X}} : \Re^{n} \longrightarrow \Re^{1}$\,
...
\item
	...
	\begin{equation*}
	\Var\!\left(\,\mathcal{L}_{\,\gamma^{T}} \overset{{\color{white}+}}{\circ} \mathcal{L}_{\,\Pi_{X}}(\,Y_{\beta}\,)\,\right)
	\;\; \leq \;\;
		\Var\!\left(\;a^{T} \overset{{\color{white}+}}{\cdot} Y_{\beta}\;\right)\,,
	\quad
...
\item
	...
	\,$\mathcal{L}_{\,\gamma^{T}} \circ \mathcal{L}_{\,\Pi_{X}} : \Re^{n} \longrightarrow \Re^{1}$\,
	as an estimator of $\mathcal{L}_{\,\gamma^{T}} \circ \mathcal{L}_{X} : \Re^{p} \longrightarrow \Re^{1}$
	in terms of \,$Y = \left\{\,Y_{\beta}\,\right\}_{\beta\in\Re^{p}}$\,,
	simply note that, for each $\beta \in \Re^{p}$, we have
	\begin{eqnarray*}
	E\!\left[\;\mathcal{L}_{\,\gamma^{T}} \circ \mathcal{L}_{\,\Pi_{X}}(\,Y_{\beta}\,)\;\right]
	& = &
...
\item
	...
	\;\, = \;\,
		E\!\left[\;\mathcal{L}_{\,a^{T}}(\,Y_{\beta}\,)\;\right]
	\;\, = \;\,
		\mathcal{L}_{\,\gamma^{T}} \circ \mathcal{L}_{X}(\,\beta\,)
	\;\, = \;\,
		\gamma^{T} \cdot X \cdot \beta\,,
...
\begin{corollary}[The Gauss-Markov Theorem: vector case]
\label{GaussMarkovTheoremVector}
\mbox{}
\vskip 0.1cm
\noindent
Suppose:
...
\Re^{n} \; \longrightarrow \; \Re^{1}
\;\; : \;\;
y \; \longmapsto \; \Pi_{X} \cdot y
\end{equation*}
is a BLUE (best linear unbiased estimator) of
\,$\mathcal{L}_{X} : \Re^{p} \longrightarrow \Re^{1}$\,
in terms of \,$Y = \left\{\,Y_{\beta}\,\right\}_{\beta\in\Re^{p}}$.}
\end{corollary}
\proof
Immediate by Proposition \ref{BLUEoneD} and the preceding Theorem \ref{GaussMarkovTheoremScalar}.
\qed
