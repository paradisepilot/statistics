...
\begin{proposition}[$X$-estimability $\Longleftrightarrow$ unique least squares estimates, vector case]
...
\begin{theorem}[$X$-estimability $\Longleftrightarrow$ unique least squares estimates, matrix case]
...
\end{equation*}
indeed defines a set-theoretic map from $\Omega$ into $\Re^{1}$.
