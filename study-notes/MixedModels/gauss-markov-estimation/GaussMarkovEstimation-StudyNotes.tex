...
\chead[]{{\Large\bf Estimation for Gauss-Markov Models} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-BLUEs-definition-properties}

\newpage
\input{z-uncorrelated-homoscedastic}

\newpage
\input{z-ColX-contained-in-ColV}

\newpage
\input{z-arbitrary-ColV}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\clearpage
\appendix
\input{z-corollary-RealSpectralTheorem}
\input{z-generalizedInverses}
\input{z-orthogonalProjections}
\input{z-LSE-estimability}
\input{z-estimability-unbiasedEstimators}
...
\bibliography{GaussMarkovEstimation-StudyNotes}
