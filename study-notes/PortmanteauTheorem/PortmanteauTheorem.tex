...
By linearity, we may assume $0 \leq f \leq 1$.
	...
	\\
	&\Longrightarrow&
		f(s_{0}) = f\!\left(\lim_{n\rightarrow\infty}s_{n}\right) = \lim_{n\rightarrow\infty}f(s_{n}) \geq t
		\;\;\textnormal{and}\;\;
		f(s_{0}) = f\!\left(\lim_{n\rightarrow\infty}s'_{n}\right) =\lim_{n\rightarrow\infty}f(s'_{n}) \leq t
