...
### (a) ############################################################################################
X <- as.matrix(cbind(rep(1,nrow(DF.data)),DF.data[,'x8']));
...
my.filename <- paste('problem-04-01-a-standardized',graphics.format,sep='.');
my.ggplot <- ggplot();
...
my.filename <- paste('problem-04-01-a-studentized',graphics.format,sep='.');
my.ggplot <- ggplot();
my.ggplot <- my.ggplot + xlim(-2.2,2.2);
my.ggplot <- my.ggplot + ylim(-2.2,2.2);
my.ggplot <- my.ggplot + geom_point(
...
my.filename <- paste('problem-04-01-b',graphics.format,sep='.');
my.ggplot <- ggplot();
...
my.filename <- paste('problem-04-01-c',graphics.format,sep='.');
my.ggplot <- ggplot();
#my.ggplot <- my.ggplot + xlim(0,12.2);
#my.ggplot <- my.ggplot + ylim(-6.2,6.2);
my.ggplot <- my.ggplot + geom_point(
