...
generate.bootstrap.sample <- function(sample.size = NULL, logf = NULL, xlimits = NULL, ylimits = NULL, prior.and.data = NULL) {
	...
	log.posterior <- logf(model.parameters = grid.points, prior.and.data = prior.and.data);
