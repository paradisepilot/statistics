...
DF.unicef.raw <- read.table(
	file       = paste0(data.directory,'/UNICEFDataRaw_v2.csv'),
	header     = TRUE,
	#na.strings = "…",
	na.strings = "–",
	sep        = "\t",
...
colnames(DF.unicef.raw) <- gsub(x = colnames(DF.unicef.raw), pattern = "^X", replacement = "");

DF.unicef.raw[DF.unicef.raw[,'2012.GNI.per.capita..US..'] %in% c('a','b','c','d'),'2012.GNI.per.capita..US..'] <- NA;
DF.unicef.raw[,'2012.GNI.per.capita..US..'] <- as.numeric(DF.unicef.raw[,'2012.GNI.per.capita..US..']);

DF.unicef.raw[,'2012.Adult.HIV.prevalence.....2012.estimate'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012.Adult.HIV.prevalence.....2012.estimate'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[,'2012.People.of.all.ages.living.with.HIV..thousands..2012.estimate'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012.People.of.all.ages.living.with.HIV..thousands..2012.estimate'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[,'2012.People.of.all.ages.living.with.HIV..thousands..2012.low'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012.People.of.all.ages.living.with.HIV..thousands..2012.low'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[,'2012.People.of.all.ages.living.with.HIV..thousands..2012.high'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012.People.of.all.ages.living.with.HIV..thousands..2012.high'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[,'2012.Women.living.with.HIV..thousands..2012'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012.Women.living.with.HIV..thousands..2012'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[,'2012..HIV.prevalence.among.young.people.....2012..total.'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012..HIV.prevalence.among.young.people.....2012..total.'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[,'2012..HIV.prevalence.among.young.people.....2012..male.'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012..HIV.prevalence.among.young.people.....2012..male.'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[,'2012..HIV.prevalence.among.young.people.....2012..female.'] <- as.numeric(gsub(
	x           = DF.unicef.raw[,'2012..HIV.prevalence.among.young.people.....2012..female.'],
	pattern     = "^<0\\.1",
	replacement = "0.1"
	));

DF.unicef.raw[DF.unicef.raw[,'US..GNI.per.capita.2012'] %in% c('a','b','c','d'),'US..GNI.per.capita.2012'] <- NA;
DF.unicef.raw[,'US..GNI.per.capita.2012'] <- as.numeric(DF.unicef.raw[,'US..GNI.per.capita.2012']);

DF.unicef.raw[DF.unicef.raw[,'total..Child.labour......2005.2012.'] %in% c('– '),'total..Child.labour......2005.2012.'] <- NA;
DF.unicef.raw[,'total..Child.labour......2005.2012.'] <- as.numeric(DF.unicef.raw[,'total..Child.labour......2005.2012.']);

#DF.unicef.raw[,''] <- as.numeric(gsub(
#	x           = DF.unicef.raw[,''],
#	pattern     = "^<0\\.1",
#	replacement = "0.1"
#	));
...
str(DF.unicef.raw[,161:197]);

write.table(
	file      = 'unicef-raw-data.csv',
	x         = DF.unicef.raw,
	sep       = ',', #'\t',
	quote     = FALSE,
	row.names = FALSE
