...
source(paste0(code.directory,'/mysql-to-RData.R'));
...
RData.CFC.Registry <- mysql.to.RData(
	mysql.connection = conn.CFC,
	output.directory = output.directory,
	output.prefix    = 'CFC-registry'
	);

save(
	file = 'CFC-Registry.RData',
	list = 'RData.CFC.Registry'
	);
