...
plotDivision <- function(
    ...
    my.ggplot <- my.ggplot + theme(
        ...
        axis.text.x       = element_text(size=textsize.axis,face="bold",color="gray",vjust=0.5),
        ...
        legend.box.margin = margin(t = 20, r = 1, b = 1, l = 1, unit = "pt"),
    ...
    my.ggplot <- my.ggplot + geom_col(
        data     = DF.long,
        mapping  = aes(y=score,x=division,fill=week),
