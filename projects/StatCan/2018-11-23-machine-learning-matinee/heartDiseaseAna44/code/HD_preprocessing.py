...
def visualize_heart_data(dataset, save_plots=True):
    ...
    if save_plots:
        plt.savefig(filename = figure1, dpi = 600, bbox_inches='tight', pad_inches=0.1)
        plt.close()
    else:
        plt.show()
    ...
    if save_plots:    
        plt.savefig(filename = figure2, dpi = 600, bbox_inches='tight', pad_inches=0.1)
        plt.close()
    else: 
        plt.show()
    ...
    if save_plots:    
        plt.savefig(filename = figure3, dpi = 600, bbox_inches='tight', pad_inches=0.1)
        plt.close()
    else: 
        plt.show()
    ...
    if save_plots:    
        plt.savefig(filename = figure4, dpi = 600, bbox_inches='tight', pad_inches=0.2)
        plt.close()
    else:
        plt.show()
